...
public class VotesDataSourceTest {
    ...
    public void shouldReturnTrueWhenUserVotedForMessage() {
        ...
        when(mockDatabaseRef.child(anyString()))
        ...
        when(mockDatabase.getReference())
                .thenReturn(mockDatabaseRef);
    ...
    public void shouldReturnFalseWhenUserVotedAgainstMessage() {
        ...
        final DataSnapshot snapshot = mock(DataSnapshot.class);
        when(snapshot.getValue(Boolean.class))
                .thenReturn(false);
        doAnswer(new Answer() {
            @Override
            public Object answer(InvocationOnMock invocation) throws Throwable {
    ...
    public void shouldReturnTrueWhenUserVoteForPersisted() {
        ...
        when(mockDatabaseRef.child(anyString()))
                ...
                .thenReturn(mockDatabaseRef)
                .thenReturn(mockDatabaseRef);
        when(mockDatabaseRef.setValue(anyBoolean()))
                .thenReturn(null);
    ...
    public void shouldReturnZeroVotesWhenMessageWasVoted() {
        ...
        when(resultsItemSnapshot.getValue(Boolean.class))
                .thenReturn(true)
                .thenReturn(false)
                .thenReturn(true);
        ...
        final DataSnapshot snapshot = mock(DataSnapshot.class);
        when(snapshot.getChildrenCount())
                .thenReturn(3L);
        when(snapshot.getChildren())
                .thenReturn(results);
